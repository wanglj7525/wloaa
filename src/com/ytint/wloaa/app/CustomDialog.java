...
public class CustomDialog extends Dialog {
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder setPositiveButton(String positiveButtonText,int color,
                DialogInterface.OnClickListener listener) {
        ...
        public CustomDialog create() {
            ...
            if (positiveButtonText != null) {
            	//((Button) layout.findViewById(R.id.positiveButton)).setBackgroundColor(positiveButtonColor);
            ...
            if (message != null) {
     /*         	 ((LinearLayout) layout.findViewById(R.id.edit_content))
                 .removeAllViews();*/
            ...
            }/*else if(editMessage!=null) 
            {
                 ...
                 .removeAllViews();
            	 ((TextView) layout.findViewById(
                 		R.id.name_edit)).setText(editMessage);
